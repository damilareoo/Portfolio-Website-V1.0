  ...
  return (
    ...
    >
      <div className="px-4 md:px-8">
        ...
        >
          <div className="relative w-full bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg overflow-hidden h-[500px] md:h-[800px] group-hover:border-[#404040] transition-colors duration-200 touch-auto" style={{ WebkitOverflowScrolling: "touch" }}>
            <iframe
