        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <span className="font-mono text-[#999] text-xs md:text-sm">current focus</span>
            </div>
          ...
          <div className="relative py-4 md:py-4 border-b border-[#1a1a1a] group-hover:border-[#404040] transition-all duration-300 md:pl-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 md:pl-4">
              <div className="flex items-center gap-3 md:gap-4">
                <span className="text-lg md:text-xl lg:text-2xl font-medium text-[#fafafa] group-hover:text-white transition-colors duration-300">
                  WorkBench
                </span>
              ...
              <span className="text-xs md:text-sm text-[#666] group-hover:text-[#a1a1a1] transition-colors duration-300">
