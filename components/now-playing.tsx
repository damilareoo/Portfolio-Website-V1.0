      ...
      >
        ...
        >
            ...
            <AnimatePresence mode="wait">
              {isPlaying ? (
                ...
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  transition={{ duration: 0.2 }}
                  style={{ width: 5, height: 5, borderRadius: "50%", background: "#2a2a2a" }}
                />
              )}
            </AnimatePresence>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            {/* Spotify icon */}
            <svg width="12" height="12" viewBox="0 0 24 24" fill="#2a2a2a" style={{ flexShrink: 0 }}>
        ...
        <AnimatePresence mode="wait">
          {loading ? (
            ...
            >
              <span style={{ fontFamily: "monospace", fontSize: "10px", color: "#2a2a2a", letterSpacing: "0.1em" }}>
                ···
              </span>
            </motion.div>
          ) : (
